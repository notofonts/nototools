  ...
  if comp:
    ...
    with open(output_file, 'w') as f:
      ...
      for _, im in sorted(coll.image_dict.items()):
        ...
        print >> f, '> rle %d' % b64_len
        print >> f, wrap_str(rle_data_b64, 80)
  else:
...
def main():
  ...
  parser.add_argument(
      '-c', '--compress', help='compress (based on input extension)', type=bool,
      nargs = '?', const=True,  metavar='tf')
  parser.add_argument(
